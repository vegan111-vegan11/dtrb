...
def main():
    ...
    args.count = "263"
    args.input_file = "C:\\Users\\TAMSystech\\yjh\\ipynb\\TextRecognitionDataGenerator\\trdg\\dicts\\전체언어텍스트파일\\th.txt"
    args.output_dir = "C:\\Users\\TAMSystech\\yjh\\ipynb\\TextRecognitionDataGenerator\\out\\th\\LG_Display_HK_HA2023"
    args.l = "th"
    args.w = "263"
    args.ft = "C:\\Users\\TAMSystech\\yjh\\ipynb\\TextRecognitionDataGenerator\\trdg\\fonts\\LG_Display_HK_HA2023.ttf"
    #python run.py --count 263 --input_file "C:\Users\TAMSystech\yjh\ipynb\TextRecognitionDataGenerator\trdg\dicts\전체 언어 텍스트 파일\th.txt"
    # --output_dir "C:\Users\TAMSystech\yjh\ipynb\TextRecognitionDataGenerator\out\th\LG_Display_HK_HA2023"
    # -l th -w 263 -ft "C:\Users\TAMSystech\yjh\ipynb\TextRecognitionDataGenerator\trdg\fonts\LG_Display_HK_HA2023.ttf"
    ...
    strings = []
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!run.py args.use_wikipedia : {args.use_wikipedia}')
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!run.py args.input_file : {args.input_file}')
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!run.py args.random_sequences : {args.random_sequences}')




    if args.use_wikipedia:
        print(f'run.py args.use_wikipedia != strings : {strings}')
        strings = create_strings_from_wikipedia(args.length, args.count, args.language)
    elif args.input_file != "":
        print(f'run.py args.input_file != args.input_file : {args.input_file}')
        print(f'run.py args.input_file != args.count: {args.count}')

        print(f'run.py args.input_file != strings type(args.input_file) : {type(args.input_file)}')
        print(f'run.py args.input_file != strings type(args.count): {type(args.count)}')

        strings = create_strings_from_file(args.input_file, args.count)
        print(f'run.py args.input_file != strings : {strings}')
        #print(f'run.py args.input_file != strings : {strings}')
    elif args.random_sequences:
        print(f'elif args.random_sequences strings : {strings}')
    ...
    t2 = FakeTextDataGenerator.generate_from_tuple
    print(f'!!!!!!!!!!!!!!!!run.py generate_from_tuple : {t2}')
    print(f'!!!!!!!!!!!!!!!!run.py fontss : {fonts}')
    print(f'!!!!!!!!!!!!!!!!run.py string_count : {string_count}')
    print(f'!!!!!!!!!!!!!!!!run.py type string_count : {type(string_count)}')
    print(f'!!!!!!!!!!!!!!!!run.py args.format : {args.format}')
    ...
    for _ in tqdm(
        ...
        pass
    p.terminate()
    print(f'args.name_format : {args.name_format}')
    ...
    if args.name_format == 2:
        ...
        with open(
            ...
            for i in range(string_count):
                ...
                file_name = args.extension  # 확장자만 사용
                label = strings[i]
                print(f'label : {label}')

                print(f'str(i) : {str(i)}')
                print(f'sfile_name : {file_name}')
    ...
    #     print(f'!!!!!!!!!!!!!!!!!33333333!args.name_format : {args.name_format}')
    #     with open(
    #         os.path.join(args.output_dir, "labels.txt"), "w", encoding="utf8"
    #     ) as f:
    #         for i in range(string_count):
    ...
    #             # file_name = args.extension  # 확장자만 사용
    #             label = strings[i]
    #             file_name = label + "." + args.extension
    #             file_name = "{}.{}".format(strings[i], args.extension)
    #             file_name = "{}.{}".format(str[i], args.extension)
    #             print(f'str[i] : {str[i]}')
    #
    #             file_name = "image-{:09d}.{}".format(str[i], args.extension)
    #             print(f'!!!!!!!!!!!!!!!!!!3333333  file_name : {file_name}')
    #
    #             # print(f'label : {label}')
    #             #
    #             # print(f'str(i) : {str(i)}')
    ...
    #             # f.write("{}\n".format(label))
        ...
        # ) as f:
        with open(
                os.path.join(args.output_dir, "gt.txt"), "w", encoding="utf8"
        ) as f:
            for i in range(string_count):
                file_name = str(i) + "." + args.extension
                #print(f'!!!!!!!!!!!!!!!!!i : {i}')
                ...
                file_name = label + "." + args.extension
                file_name = "{}.{}".format(strings[i], args.extension)
                file_name = "{}.{}".format(t, args.extension)
                #print(f'!!!!!!!!!!!!!!!!!str[i] : {str[i]}')
                imageKey = 'image-%09d'.encode() % i
                imageKey = 'image-%09d' % i

                #print(f'!!!!!!!!!!!!!!!!!imageKey : {imageKey}')
                #file_name = "image-{:09d}.{}".format(t, args.extension)
                file_name = "{}.{}".format(imageKey, args.extension)
                #print(f'!!!!!!!!!!!!!!!!!!3333333  file_name : {file_name}')
