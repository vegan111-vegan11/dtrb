...
val_image_folder = fr'D:\deep-text-recognition-benchmark\data\{lan}\rect_invert\train\img'
val_gt_file_path = fr'D:\deep-text-recognition-benchmark\data\{lan}\rect_invert\train\gt\gt.txt'
