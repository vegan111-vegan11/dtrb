...
# columns_and_values = {
#     '태국어_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_Sharpening_result': 0.21,
#     '태국어_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_imageProcessing_result': 0.21,
#     '태국어_NotoSansThaiLooped-Bold_전처리_미디안필터_kernel_3_Sharpening_result'': 0.06,
#     '태국어_NotoSansThaiLooped-Bold_전처리_미디안필터_kernel_3_imageProcessing_result': 0.1,
#     '태국어_NotoSansThaiLooped-ExtraBold_전처리_미디안필터_kernel_3_Sharpening_result': 0.0 ,
#     '태국어_NotoSansThaiLooped-ExtraBold_전처리_미디안필터_kernel_3_imageProcessing_result': 0.05,
#     '태국어_NotoSansThaiLooped-ExtraLight_전처리_미디안필터_kernel_3_Sharpening_result': 0.06,
#     '태국어_NotoSansThaiLooped-ExtraLight_전처리_미디안필터_kernel_3_imageProcessing_result': 0.1,
#     '태국어_NotoSansThaiLooped-Light_전처리_미디안필터_kernel_3_Sharpening_result': 0.0 ,
#     '태국어_NotoSansThaiLooped-Light_전처리_미디안필터_kernel_3_imageProcessing_result': 0.05,
#
#     '태국어_NotoSansThaiLooped-Medium_전처리_미디안필터_kernel_3_Sharpening_result': 0.06,
#     '태국어_NotoSansThaiLooped-ExtraLight_전처리_미디안필터_kernel_3_imageProcessing_result': 0.1,
#     '태국어_NotoSansThaiLooped-Light_전처리_미디안필터_kernel_3_Sharpening_result': 0.0 ,
#     '태국어_NotoSansThaiLooped-Light_전처리_미디안필터_kernel_3_imageProcessing_result': 0.05
# }
columns_and_values = {'태국어_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_Sharpening_result': 0.03,
                      '태국어_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_imageProcessing_result': 0.03,
                      '태국어_NotoSansThaiLooped-Bold_전처리_미디안필터_kernel_3_Sharpening_result': 0.03,
                      '태국어_NotoSansThaiLooped-Bold_전처리_미디안필터_kernel_3_imageProcessing_result': 0.03,
                      '태국어_NotoSansThaiLooped-ExtraBold_전처리_미디안필터_kernel_3_Sharpening_result': 0.03,
                      '태국어_NotoSansThaiLooped-ExtraBold_전처리_미디안필터_kernel_3_imageProcessing_result': 0.03,
                      '태국어_NotoSansThaiLooped-ExtraLight_전처리_미디안필터_kernel_3_Sharpening_result': 0.03,
                      '태국어_NotoSansThaiLooped-ExtraLight_전처리_미디안필터_kernel_3_imageProcessing_result': 0.03,
                      '태국어_NotoSansThaiLooped-Light_전처리_미디안필터_kernel_3_Sharpening_result': 0.03,
                      '태국어_NotoSansThaiLooped-Light_전처리_미디안필터_kernel_3_imageProcessing_result': 0.03,
                      '태국어_NotoSansThaiLooped-Medium_전처리_미디안필터_kernel_3_Sharpening_result': 0.03,
                      '태국어_NotoSansThaiLooped-Medium_전처리_미디안필터_kernel_3_imageProcessing_result': 0.03,
                      '태국어_NotoSansThaiLooped-Regular_전처리_미디안필터_kernel_3_Sharpening_result': 0.03,
                      '태국어_NotoSansThaiLooped-Regular_전처리_미디안필터_kernel_3_imageProcessing_result': 0.03
                      }
...
#     #columns_and_values[col] = df[col][0]
#     print(fr'type(value_in_parentheses : {type(value_in_parentheses)}')
#     # value_in_parentheses를 부동 소수점 숫자로 변환
#     value_float = float(value_in_parentheses)
#
#     #columns_and_values[col] = value_in_parentheses
#     columns_and_values[col] = value_float
#
#
...
excel_file_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\ocr_test\0110\{lan}\결과\{4}\태국어_전처리_with_result_updated_test7_black_background_margin_kernel_3_원본_0.03_결과만_pre_procession.xlsx'
result_df.to_excel(excel_file_path, index=False)

print(fr'result_df :{result_df}')
...
print(fr'font_groups :{font_groups}')
...
#fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(12, 10))
# 서식별로 서브플롯에 그래프 그리기
#fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(18, 12))  # 그래프 가로 길이를 늘림
#fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(18, 12))  # 그래프 가로 길이를 늘림
#fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(18, 16))  # 전체 세로 길이를 늘림
#fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(18, 12))  # 그래프 가로 길이를 늘림
#fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(12, 10))
...
# 서브플롯 간 간격 조절
# 라벨 간격 조절
plt.subplots_adjust(wspace=0.5, hspace=0.5)  # 상하좌우 간격을 조정합니다.
#plt.subplots_adjust(wspace=1, hspace=1)  # 상하좌우 간격을 조정합니다.
plt.tight_layout()
plt.show()
