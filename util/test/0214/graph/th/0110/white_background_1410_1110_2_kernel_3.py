...
# }
columns_and_values = {
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_Sharpening_result': 0.33,
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_imageProcessing_result': 0.34
}
...
plt.title(fr'{lan}_white_background_1410_1110 * 2_kernel_3 전처리 방법별 성공률', fontsize=14, color=(150/255, 150/255, 150/255))
