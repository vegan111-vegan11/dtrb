...
# }
columns_and_values = {
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_Sharpening_result': 0.05,
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_imageProcessing_result': 0.04
}
...
plt.title(fr'{lan}_white_background_1410_1110 * 8_kernel_3 전처리 방법별 성공률', fontsize=14, color=(150/255, 150/255, 150/255))
