...
columns_and_values = {
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_5_Sharpening_result': 0.21,
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_5_imageProcessing_result': 0.21,
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_7_Sharpening_result': 0.06,
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_7_imageProcessing_result': 0.1,
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_9_Sharpening_result': 0.0 ,
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_9_imageProcessing_result': 0.05
}
...
plt.title(fr'{lan}_white_background_1410_1110_kernel_5_7_9 전처리 방법별 성공률', fontsize=14, color=(150/255, 150/255, 150/255))
