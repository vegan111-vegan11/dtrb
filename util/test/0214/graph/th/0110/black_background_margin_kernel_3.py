...
# }
columns_and_values = {
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_Sharpening_result': 0.03,
    'th_NotoSansThaiLooped-Black_전처리_미디안필터_kernel_3_imageProcessing_result': 0.03
}
...
plt.title(fr'{lan}_black_background_1410_1110_kernel_3_rect 전처리 방법별 성공률', fontsize=14, color=(150/255, 150/255, 150/255))
