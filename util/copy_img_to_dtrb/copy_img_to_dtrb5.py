...
source_folder = r'C:\Users\TAMSystech\yjh\ipynb\TextRecognitionDataGenerator\out3\th\01-08'
...
destination_folder = r'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\ttf15\train\img'

# 필요없는 부분을 제거할 경로 문자열
remove_path = r'\distorsion(0)\distorsion_orientation(0)\resize_orientation(0)\background(3)\background_rgb(0)\alignment(1)'
#remove_path = r'\distorsion(0)\distorsion_orientation(0)\resize_orientation(0)\background(3)\background_rgb(0)\alignment(1)\NotoSansThaiLooped-'
...
src_replace_path = r'TextRecognitionDataGenerator\out3\th\01-08'
dst_replace_path = r'deep-text-recognition-benchmark\data\ttf15\train\img'
