...
input_directory = fr'D:\deep-text-recognition-benchmark\data\{lan}\rect_invert\val\img'
output_directory = fr'D:\deep-text-recognition-benchmark\data\{lan}\rect_invert_2\val\img'
input_directory = fr'D:\deep-text-recognition-benchmark\data\{lan}\rect_invert'
output_directory = fr'D:\deep-text-recognition-benchmark\data\{lan}\rect_invert_2'
input_directory = fr'D:\deep-text-recognition-benchmark\data\{lan}\rect_invert\train\img'
output_directory = fr'D:\deep-text-recognition-benchmark\data\{lan}\rect_invert_2\train\img'
...
def resize_images_in_directory(input_directory, output_directory, scale_factor=2.0):
    for root, dirs, files in os.walk(input_directory):
        print(fr'root : {root}')
        print(fr'dirs : {dirs}')
        #print(fr'files : {files}')

        # output_subdirectory = os.path.join(output_directory, os.path.basename(root))
        # os.makedirs(output_subdirectory, exist_ok=True)
        # resize_and_save(image_path, output_subdirectory, scale_factor)
        ...
        for filename in files:
            if filename.endswith(".jpg") or filename.endswith(".png"):
                ...
                os.makedirs(output_subdirectory, exist_ok=True)
                resize_and_save(image_path, output_subdirectory, scale_factor)
                #resize_and_save(image_path, output_directory, scale_factor)


# 함수를 호출하여 이미지 크기를 조정하고 저장합니다.
resize_images_in_directory(input_directory, output_directory, scale_factor=2.0)
