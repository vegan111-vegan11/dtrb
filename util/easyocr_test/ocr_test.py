...
# # 엑셀 파일 읽기
# # 되는거 전처리 후
# # df = pd.read_excel('D:/data/{lan}/{lan}_전처리.xlsx')
# # df = pd.read_excel('D:/data/{lan}/{lan}_전처리.xlsx')
...
#
# # 이미지 디렉토리 설정
# image_dir = 'C:/Users/TAMSystech/yjh/img/{lan}'
...
#             # filename과 같은 {lan} 열의 인덱스를 찾습니다.
#             print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!ocr test df : {df}')
#             idx = df.index[df['{lan}'] == filename].tolist()
#
#             if not idx:
...
#                 # OCR 결과를 업데이트
#
#                 if recognized_text == df.at[idx[0], '{lan}']:
...
# 엑셀 파일 경로
file_path = fr'D:/data/ocr/1018/{lan}_전처리_with_result_updated.xlsx'
file_path = fr'D:/data/ocr/1215/{lan}_전처리_with_result_updated.xlsx'
file_path = fr'D:/data/ocr/1226/{lan}_전처리_with_result_updated.xlsx'
...
# 경로 설정
gt_base_path = r'C:\Users\TAMSystech\yjh\gt\{lan}'
gt_base_path = r'C:\Users\TAMSystech\yjh\gt\{lan}'
    ...
    for dir_name in dirs:
        ...
        for ks in ks_list:
            ...
            for preprocessing_name, preprocessing_func in preprocessing_steps:
                ...
                #     index=False)
                df.to_excel(
                    fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0110/{lan}/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{2}_kernel_3_원본.xlsx',
                    index=False)
