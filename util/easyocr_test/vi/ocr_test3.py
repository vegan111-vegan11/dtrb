    ...
    for dir_name in dirs:
        ...
        for ks in ks_list:
            ...
            for preprocessing_name, preprocessing_func in preprocessing_steps:
                ...
                #     index=False)
                df.to_excel(
                    fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{8}_kernel_3_원본_수정_{베트남어_성공률}.xlsx',
                    index=False)
