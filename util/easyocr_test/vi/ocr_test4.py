...
# # 엑셀 파일 읽기
# # 되는거 전처리 후
# # df = pd.read_excel('D:/data/베트남어/{lan}_전처리.xlsx')
# # df = pd.read_excel('D:/data/베트남어/{lan}_전처리.xlsx')
# file_path = 'D:/data/ocr/1107/{lan}_전처리_with_result_updated.xlsx'  # 엑셀 파일 경로
...
# ks_list = [1, 3, 5, 7, 9]
# ks_list = [1 ]
# # ocr_text_열명 = '{lan}_전처리_이진화_미디안필터_ocr_text'
# # result_열명 = '{lan}_전처리_이진화_미디안필터_result'
# ocr_text_열명 = '{lan}_ocr_text'
# result_열명 = '{lan}_result'
# ocr_text_열명 = '{lan}_전처리_미디안필터_kernel_7_ocr_text'
# result_열명 = '{lan}_전처리_미디안필터_kernel_7_result'
#
...
#             # for ks in ks_list:
#             ocr_text_열명 = f'{lan}_전처리_미디안필터_kernel_{ks}_ocr_text'
#             result_열명 = f'{lan}_전처리_미디안필터_kernel_{ks}_result'
#             # 이미지에 미디안 필터 적용
#
...
#
#                 # 추출된 텍스트를 '{lan}_ocr_text' 열에 넣습니다.
...
# 엑셀 파일 경로
file_path = 'D:/data/ocr/1018/{lan}_전처리_with_result_updated.xlsx'
file_path = 'D:/data/ocr/1215/{lan}_전처리_with_result_updated.xlsx'
file_path = 'D:/data/ocr/1226/{lan}_전처리_with_result_updated.xlsx'
file_path = 'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/1226/{lan}_전처리_with_result_updated.xlsx'
file_path = 'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0110/베트남어/{lan}_전처리_with_result_updated.xlsx'
file_path = fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/{lan}_전처리_with_result_updated.xlsx'
...
base_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\{lan}\test7_white_background_1800_760_{2}_rect_{2}\train\img\skew_angle(0.0)\blur(0.0)'
base_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\{lan}\test7_white_background_1800_760_{4}\train\img\skew_angle(0.0)\blur(0.0)'
base_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\{lan}\test7_white_background_1800_760_{8}\train\img\skew_angle(0.0)\blur(0.0)'
base_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\{lan}\ocr_test\test7_white_background_1800_760_{4}\train\img\skew_angle(0.0)\blur(0.0)'
base_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\{lan}\ocr_test\test7_white_background_1800_760_{4}_filter\train\img\skew_angle(0.0)\blur(0.0)'
    ...
    for dir_name in dirs:
        ...
        for ks in ks_list:
            ...
            for preprocessing_name, preprocessing_func in preprocessing_steps:
                ...
                for filename in os.listdir(image_dir):
                    ...
                    if filename.endswith(".jpg"):
                        ...
                        if not idx:
                            ...
                            #if recognized_text == df.at[idx[0], '베트남어']:
                            if df.at[idx[0], '베트남어'] in recognized_text:
                                df.at[idx[0], result_열명] = 'suc'
                                # 조건을 만족하는 모든 행 업데이트
                ...
                print(f"베트남어_suc_cnt:@@@@@@@@@@@@@@@@@@@@@@@@@ {베트남어_suc_cnt}")
                # df.to_excel('D:/data/ocr/1018/{lan}_전처리_with_result_updated.xlsx', index=False)
                #df.to_excel('D:/data/ocr/1215/{lan}_전처리_with_result_updated.xlsx', index=False)
                # df.to_excel('D:/data/ocr/1226/{lan}_전처리_with_result_updated.xlsx', index=False)
                # df.to_excel('C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/1226/{lan}_전처리_with_result_updated.xlsx', index=False)
                # df.to_excel(
                #     'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0110/{lan}_전처리_with_result_updated.xlsx',
                #     index=False)
                # df.to_excel(
                #     'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0110/베트남어/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_2_kernel_3_원본.xlsx',
                #     index=False)

                # df.to_excel(
                #     fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{2}_rect_{2}_kernel_3_원본_수정.xlsx',
                #     index=False)
                # df.to_excel(
                #     fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{4}_kernel_3_원본_수정_{베트남어_성공률}.xlsx',
                #     index=False)
                # df.to_excel(
                #     fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/ocr_test_{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{4}_filter_kernel_3_원본_수정_{베트남어_성공률}.xlsx',
                #     index=False)

                # df.to_excel(
                #     fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{4}_kernel_3_원본_수정_all.xlsx',
                #     index=False)
                # df.to_excel(
                #     fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{4}_kernel_3_원본_수정_all_{베트남어_성공률}.xlsx',
                #     index=False)
                # df.to_excel(
                #     fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/ocr_test_{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{4}_filter_kernel_3_원본_수정_all_{best_succ}.xlsx',
                #     index=False)
                df.to_excel(
                    fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/ocr_test_{lan}_전처리_with_result_updated_test7_white_background_1410_1110_{4}_filter_kernel_3_원본_수정.xlsx',
                    index=False)

        print(f"일치하는 항목 수: {베트남어_suc_cnt}")
        print(f"베트남어_성공률: {베트남어_성공률}")
        print(f"best_succ: {best_succ}")
