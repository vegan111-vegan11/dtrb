...
# # 엑셀 파일 읽기
# # 되는거 전처리 후
# # df = pd.read_excel('D:/data/태국어/{lan}_전처리.xlsx')
# # df = pd.read_excel('D:/data/태국어/{lan}_전처리.xlsx')
...
file_path = 'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0110/태국어/{lan}_전처리_with_result_updated.xlsx'
...
file_path = fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0123/{lan}/{lan}_전처리_with_result_updated.xlsx'
...
lan = 'vi'
lan = 'th'
user_network_directory = fr'C:/Users/TAMSystech/.EasyOCR/user_network'
...
#reader = easyocr.Reader(['th', 'en'], model_storage_directory = user_network_directory, recog_network='None_VGG_BiLSTM_CTC')
#reader = easyocr.Reader(['th', 'en'],  recog_network='None_VGG_BiLSTM_CTC')
#reader = easyocr.Reader(['th', 'en'],  recog_network=fr'None_VGG_BiLSTM_CTC_{lan}')
reader = easyocr.Reader(['th'])
# user_network_directory = r'C:/Users/TAMSystech/.EasyOCR/user_network'
#user_network_directory = r'C:/Users/TAMSystech/.EasyOCR/user_network'
#reader = easyocr.Reader(['th', 'en'], model_storage_directory = user_network_directory, recog_network='None_VGG_BiLSTM_CTC')
...
base_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\{lan}\test\test7_white_background_1800_760_4\train\img\skew_angle(0.0)\blur(0.0)'
base_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\{lan}\test\0118\train\img\skew_angle(0.0)\blur(0.0)'
base_path = fr'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\{lan}\test\0123\train\img\skew_angle(0.0)\blur(0.0)'
    ...
    for dir_name in dirs:
        ...
        for ks in ks_list:
            ...
            for preprocessing_name, preprocessing_func in preprocessing_steps:
                ...
                for filename in os.listdir(image_dir):
                    ...
                    if filename.endswith(".jpg"):
                        ...
                        if not idx:
                            ...
                            #if recognized_text == df.at[idx[0], '태국어']:
                            if df.at[idx[0], '태국어'] in recognized_text:
                                df.at[idx[0], result_열명] = 'suc'
                                # 조건을 만족하는 모든 행 업데이트
                ...
                #     index=False)
                # df.to_excel(
                #     'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0110/태국어/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_2_kernel_3_원본.xlsx',
                #     index=False)

                # df.to_excel(
                #     fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0112/{lan}/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_2_kernel_3_원본_수정.xlsx',
                #     index=False)
                df.to_excel(
                    fr'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0123/{lan}/{lan}_전처리_with_result_updated_test7_white_background_1410_1110_2_kernel_3_원본_수정.xlsx',
                    index=False)
