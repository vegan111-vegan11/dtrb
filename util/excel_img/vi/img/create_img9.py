...
print('열려야 함======================')
excel_file_path = "D:\\text_file\\라인명\\test\\NotoSansThaiLooped-Thin\\000000028.xlsx"
excel_file_path = fr"D:\text_file\라인명\{len}\{font}\000000028.xlsx"
import os

excel_file_folder = fr"D:\text_file\라인명\{lan}\{font}"
#excel_file_folder = fr"D:\text_file\라인명\test\{font}"

# os.walk()를 사용하여 폴더 구조 탐색
for folder_path, _, files in os.walk(excel_file_folder):
    print("=====================")
    ...
    for file_name in files:
        ...
        x, y, width, height = 30, 500, 1800, 760  # 캡처하려는 화면 영역의 좌표와 크기
        x, y, width, height = 30, 200, 1800, 760  # 캡처하려는 화면 영역의 좌표와 크기
        x, y, width, height = 30, 300, 1800, 760  # 캡처하려는 화면 영역의 좌표와 크기
        x, y, width, height = 30, 300, 1800, 560  # 캡처하려는 화면 영역의 좌표와 크기
        x, y, width, height = 30, 400, 1800, 560  # 캡처하려는 화면 영역의 좌표와 크기
        x, y, width, height = 30, 440, 1800, 560  # 캡처하려는 화면 영역의 좌표와 크기
        x, y, width, height = 30, 440, 1800, 500  # 캡처하려는 화면 영역의 좌표와 크기
        ...
        output_file_path = os.path.join(output_folder, f'image-{int(file_base_name):09d}.jpg')
