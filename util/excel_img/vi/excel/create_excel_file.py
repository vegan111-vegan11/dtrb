...
file_path = fr'C:\Users\TAMSystech\yjh\text_file\전체 언어 텍스트 파일\ttf3\common\{lan}_빈문자열 제거.txt'
...
for root, dirs, files in os.walk(base_directory):
    for directory in dirs:
        ...
        input_file_path = fr'C:\Users\TAMSystech\yjh\text_file\전체 언어 텍스트 파일\ttf3\{directory}\{lan}_빈문자열 제거_test.txt'
        ...
        output_folder_path = fr'C:\Users\TAMSystech\yjh\text_file\라인명\excel\{lan}\{font}'
        ...
        with open(input_file_path, 'r', encoding='utf-8') as input_file:
            ...
            print(f'lines : {lines}')
            data_to_write = [line.strip() for line in lines]
        ...
        for line_number, line in enumerate(data_to_write, 0):
        #for row_data in data_to_write:
            # 파일명으로 사용할 내용
            ...
            output_file_path = os.path.join(output_folder_path, f'{file_path}.xlsx')
