...
def find_last_directory_with_jpg(directory_path, base_path):
    ...
    for dirpath, dirnames, filenames in os.walk(directory_path):
        ...
        #     if filename.lower().endswith('.jpg'):
                ...
                mdb_path = last_directory_with_jpg.replace(r'\data', r'\data_lmdb_release')
                mdb_path = last_directory_with_jpg.replace(r'\data', fr'\data_lmdb_release\{lan}')
                mdb_path = last_directory_with_jpg.replace(r'\data', fr'\data_lmdb_release')
        ...
        # 특정 부분 제거
                ...
                cmd = [
                    ...
                    #'python', os.path.join('/th/create_lmdb_dataset_dir', 'create_lmdb_dataset.py'),
                    #'python', fr'C:\Users\TAMSystech\yjh\ipynb\deep - text - recognition - benchmark\util\run_create_dataset\run_create_dataset_dir\create_lmdb_dataset.py',

                    'python', os.path.join('../create_lmdb_dataset_dir', 'create_lmdb_dataset.py'),
                    '--inputPath', dirpath,
...
img_folder =  fr'{lan}/rect_invert'
img_folder =  fr'{lan}/rect_invert'
img_folder =  fr'{lan}/test/0226'
img_folder =  fr'{lan}/test2/0226'
img_folder =  fr'{lan}/test3/0226'
img_folder =  fr'{lan}/rect_invert'
img_folder =  fr'{lan}/rect_invert'
img_folder =  fr'{lan}/ttf13'
#img_folder =  fr'{lan}/rect_invert\train'
#img_folder =  'test/0115/train'
#img_folder =  'test/train'
