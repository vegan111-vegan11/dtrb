...
# base_path = r'C:\Users\TAMSystech\yjh\text_file\라인명4\태국어'
#
...
# #     print(f'font = \'{font}\'')
#
# # font_list를 반복하면서 디렉터리 생성
# for font_name in font_list:
#     directory_path = os.path.join(base_path, font_name)
#
#     # 디렉터리가 존재하지 않으면 생성
...
for root, dirs, files in os.walk(base_directory):
    for directory in dirs:
        ...
        output_folder_path = fr'C:\Users\TAMSystech\yjh\text_file\라인명4\{lan}\{font}'
