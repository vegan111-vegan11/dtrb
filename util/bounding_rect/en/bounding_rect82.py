...
#source_path = fr'D:\img\라인명\{lan}\{font}'
#source_path = fr'D:\img\{lan}\margin'
...
for root, dirs, files in os.walk(source_path):
    for dir_name in dirs:
        ...
        for filename in os.listdir(source_dir_path):
            ...
            #if filename.lower().endswith('.jpg'):
            #if filename.lower().endswith('.jpg'):
            #if filename.lower().endswith('.jpg') and re.match(r'^image-\d{9}\.jpg$', filename.lower()):
            #if filename == "image-000000000.jpg":
            if filename.lower().endswith('.jpg'):
