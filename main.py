...
from pythonlib_easyocr.easyocr import Reader
import sys
import time
...
class PororoOcr:
    def __init__(self, model: str = "brainocr", lang: str = "ko", **kwargs):
        ...
        if lang == "ko":  # wwww
            ...
            print(fr' PororoOcr lang : {current_path} {lang}')
            # 원본 모델 사용시
            ...
            for idx, text_result in enumerate(self.ocr_result):
                ...
                print(fr'idx : {current_path} {idx}')
                print(fr'text_result : {current_path} {text_result}')
                print(fr'self.ocr_result : {current_path} {self.ocr_result}')

                text = text_result[1]

                print(fr'text_result[1] : {current_path} {text_result[1]}')

                text_list.append(text)

                print(fr'text_list : {current_path} {text_list}')

                coord = text_result[0]

                print(fr'coord : {current_path} {coord}')

                self.coord_list.append(coord)

                print(fr'self.coord_list : {current_path} {self.coord_list}')

            ocr_text = text_list

            print(fr'ocr_text : {current_path} {ocr_text}')
