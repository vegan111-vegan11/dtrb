...
def find_last_directory_with_jpg(directory_path, base_path):
    ...
    for dirpath, dirnames, filenames in os.walk(directory_path):
        ...
        if not dirnames:
            ...
            print(f' if not dirnames dirnames : {dirnames}')
            ...
            for filename in filenames:
                if filename.lower().endswith('.jpg'):
                    ...
                    train_path = last_directory_with_jpg.replace(r'\ttf14', r'\train')
                    validation_path = last_directory_with_jpg.replace(r'\ttf14', r'\val')
                    ...
                    training_mdb_path = last_directory_with_jpg.replace(r'\data\ttf14', r'\data_lmdb_release\training\ttf14')
                    validation_mdb_path = last_directory_with_jpg.replace(r'\data\ttf14', r'\data_lmdb_release\validation\ttf14')
                    ...
                    #mdb_path = mdb_path.replace(r'\data\ttf14', r'\data_lmdb_release\validation\ttf14')
...
src_path = r'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\ttf14'
directory_path = r'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\ttf14'
base_path = r'C:\Users\TAMSystech\yjh\ipynb\deep-text-recognition-benchmark\data\ttf14'
