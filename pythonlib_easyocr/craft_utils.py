...
def getDetBoxes_core(textmap, linkmap, text_threshold, link_threshold, low_text, estimate_num_chars=False):
    ...
    print(fr'getDetBoxes_core det : {current_path} {det}')
    print(fr'getDetBoxes_core labels : {current_path} {labels}')
    print(fr'getDetBoxes_core mapper : {current_path} {mapper}')
...
def getDetBoxes(textmap, linkmap, text_threshold, link_threshold, low_text, poly=False, estimate_num_chars=False):
    ...
    if poly:
        ...
        print(fr'getDetBoxes polys : {current_path} {polys}')
    else:
        polys = [None] * len(boxes)

    print(fr'getDetBoxes boxes : {current_path} {boxes}')
    print(fr'getDetBoxes polys : {current_path} {polys}')
    print(fr'getDetBoxesmapper  : {current_path} {mapper}')
