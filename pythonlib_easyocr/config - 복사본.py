...
#MODULE_PATH = "C:/ProgramData/PY/misc"
MODULE_PATH = os.getcwd() or os.environ.get("EASYOCR_MODULE_PATH") or os.environ.get("MODULE_PATH") or os.path.expanduser("~/.EasyOCR/")
