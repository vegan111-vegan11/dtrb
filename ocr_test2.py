...
# 엑셀 파일 경로
file_path = 'D:/data/ocr/1018/베트남어_전처리_with_result_updated.xlsx'
file_path = 'D:/data/ocr/1215/베트남어_전처리_with_result_updated.xlsx'
file_path = 'D:/data/ocr/1226/베트남어_전처리_with_result_updated.xlsx'
file_path = 'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/1226/베트남어_전처리_with_result_updated.xlsx'
file_path = 'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0110/베트남어/베트남어_전처리_with_result_updated.xlsx'
    ...
    for dir_name in dirs:
        ...
        for ks in ks_list:
            ...
            for preprocessing_name, preprocessing_func in preprocessing_steps:
                ...
                #     index=False)
                df.to_excel(
                    'C:/Users/TAMSystech\yjh\ipynb\deep-text-recognition-benchmark/ocr_test/0110/베트남어/베트남어_전처리_with_result_updated_test7_white_background_1410_1110_2_kernel_3_원본.xlsx',
                    index=False)
